...
def save():
    ...
    saver.save(sess, 'C:/Users/Administrator/Desktop/save/', write_meta_graph=False)  # meta_graph is not recommended
...
def reload():
    ...
    saver = tf.train.Saver()  # define a saver for saving and restoring
    saver.restore(sess, 'C:/Users/Administrator/Desktop/save/')
